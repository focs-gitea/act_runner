...
func loadExecCmd(ctx context.Context) *cobra.Command {
	...
	execCmd.PersistentFlags().StringVarP(&execArg.image, "image", "i", "gitea/runner-images:ubuntu-22.04", "Docker image to use. Use \"-self-hosted\" to run directly on the host.")
